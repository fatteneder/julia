...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    *(size_t*)jl_an_empty_string = 0;
    ...
    jl_code_instance_type =
        jl_new_datatype(jl_symbol("CodeInstance"), core,
                        ...
                        jl_perm_symsvec(18,
                            ...
                            "invoke", "specptr", "cpjit_mc"), // function object decls
                        jl_svec(18,
                            jl_method_instance_type,
                            jl_any_type,
                            jl_any_type,
                            ...
                            jl_bool_type,
                            jl_uint8_type,
                            jl_any_type, jl_any_type, jl_any_type), // fptrs
                        jl_emptysvec,
                        0, 1, 1);
    ...
    const static uint32_t code_instance_atomicfields[1] = { 0b111011010100011100 }; // Set fields 3-5, 9, 11, 13-14, 16-18 as atomic
